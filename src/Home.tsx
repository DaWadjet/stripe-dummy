    ...
    <>
      <Center h={"100vh"} color="black">
        <VStack spacing="24px">
          ...
          <Button colorScheme={"teal"} onClick={navigateToIntegratedCheckout}>
            Integrated Checkout
          </Button>
          <Button colorScheme={"blue"} onClick={navigateToHostedCheckout}>
            Hosted Checkout
          </Button>
          <Button colorScheme={"yellow"} onClick={navigateToNewSubscription}>
            New Subscription
          </Button>
          <Button colorScheme={"purple"} onClick={navigateToCancelSubscription}>
            Cancel Subscription
          </Button>
          <Button
          ...
          <Button colorScheme={"pink"} onClick={navigateToViewInvoices}>
            View Invoices
          </Button>
        </VStack>
      </Center>
